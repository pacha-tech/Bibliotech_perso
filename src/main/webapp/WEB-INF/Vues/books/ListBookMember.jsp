                ...
                <c:forEach var="book" items="${listbooks}" varStatus="num">
                    <div class="book-card">
                        ...
                        <div class="card-initial-details">
                            ...
                            <p class="card-year">
                                <c:set var="isBorrowedByUser" value="${loanedStatusMap[book.id_Book]}"/>
                                <c:set var="isReservedByUser" value="${reservedStatusMap[book.id_Book]}"/>
                                <c:choose>
                                    <c:when test="${isBorrowedByUser == true}">
                                        <p class="btn btn-warning"> déjà Emprunter </p>
                                    </c:when>

                                    <c:when test="${isReservedByUser == true}">
                                        <p class="btn btn-warning"> déjà Reserver </p>
                                    </c:when>
